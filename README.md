...
- Clone this repo
  ```sh
  # git clone https://github.com/microservice-framework/api-note-example-1.git
  Cloning into 'api-note-example-1'...
  remote: Counting objects: 11, done.
  remote: Compressing objects: 100% (10/10), done.
  remote: Total 11 (delta 1), reused 6 (delta 0), pack-reused 0
  Unpacking objects: 100% (11/11), done.
  # cd api-note-example-1
  ```
...
- Install all services that a part of this bundle
  ...
  # mfw setup
	...
	-	downloading example-note
	-	downloading microservice-auth
	-	downloading microservice-users
	-	downloading microservice-users-login
	-	copiyng microservice-users-login to YOUR_LOCAL_DIR/api-note-example-1/services/microservice-users-login
	-	copiyng microservice-users to YOUR_LOCAL_DIR/api-note-example-1/services/microservice-users
	-	updating dependencies for microservice-users
	-	updating dependencies for microservice-users-login
	-	copiyng example-note to YOUR_LOCAL_DIR/api-note-example-1/services/example-note
	-	updating dependencies for example-note
	-	copiyng microservice-auth to YOUR_LOCAL_DIR/api-note-example-1/services/microservice-auth
	-	copiyng microservice-router to YOUR_LOCAL_DIR/api-note-example-1/services/microservice-router
